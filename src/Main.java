public class Main {
    public static void main(String[] args) {
        ...
        Car murcielago=new Car("Lamborghini","Murcielago","оранжевый","6,19 л.");
        Car murcielagob=new Car("Lamborghini","Murcielago","белый","6,19 л.");
        Car murcielagoc=new Car("Lamborghini","Murcielago","красный","6,19 л.");
        Car murcielagod=new Car("Lamborghini","Murcielago","жёлтый","6,19 л.");
